...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #To add each candidate's election results to the election_analysis.txt file, we are going to take out the code inside the print() function and place it in a variable, candidate_results, like this:
        candidate_results = (
